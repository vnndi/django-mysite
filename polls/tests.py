...
class QuestionIndexViewTests(TestCase):
    def test_no_questions(self):
        """If no questions exsits, an appropriate message is displayed"""
...
class QuestionDetailviewTests(TestCase):
    ...
    def test_past_question(self):
        """The detail view of a question with a pub_date in the past displays the quesiton's text."""
        past_question = create_question(question_text='Pas Question.', days=-5)
